...
<form class="ui form" action="controller/UserController.php" method="post">
    ...
    <div class="field">
        ...
        <input id="fullname" value="<?php echo $sql[0]['fullname'] ?>" type="text" name="fullname" required=""
               maxlength="50"
    ...
    <div class="two fields">
        <div class="field">
            ...
            <input id="phone" type="text" name="phone" value="<?php echo $sql[0]['phone'] ?>" required="" maxlength="17"
                   onkeypress="return event.charCode >= 48 && event.charCode <= 57">
        </div>
        <div class="field">
            <label for="email">Email</label>
            <input id="email" type="email" name="email" required="" maxlength="100"
                   value="<?php echo $sql[0]['email'] ?>">
        </div>
    </div>
    </div>
    <div class="actions">
