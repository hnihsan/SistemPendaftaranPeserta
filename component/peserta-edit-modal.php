                                ...
                                <div class="field">
                                    <div class="ui radio checkbox">
                                        <input type="radio" value='1'
                                               name="sem[<?php echo $sem['id'] ?>]" <?php if ($sem['status'] == 1) echo 'checked="checked"' ?>>
                                        <label>Hadir</label>
                                    </div>
                                </div>
                                <div class="field">
                                    <div class="ui radio checkbox">
                                        <input type="radio" value='0'
                                               name="sem[<?php echo $sem['id'] ?>]" <?php if ($sem['status'] == 0) echo 'checked="checked"' ?>>
                                        <label>Batal</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="content"><?php echo $sem['nama'] ?></div>
                    </div>
                <?php } ?>
            </div>
        </div>
